...
The script restores header/demo files, deletes live `/create-rule` output (`.cursor/rules/`, `colocated-react-tests`), and closes leftover `cursor/*` PRs on **novarz/grafana-demo**. Dependabot is disabled on this repo.
