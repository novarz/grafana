...
The script restores header/demo files, deletes live `/create-rule` output (`.cursor/rules/`, `colocated-react-tests`), closes leftover `cursor/*` PRs on **novarz/grafana**. It will close leftover 201 PRs (e.g. notice-banner). Leave dependabot PRs unless the user asks.
